...
oInputbox = function (w, h, default_text, empty_text, textcolor, backcolor, bordercolor, backselectioncolor, func, parentObjectName, id, font_size, bg_alpha) {
    ...
    this.drag = false;
    //
    if(cInputbox.timer_cursor) window.ClearTimeout(cInputbox.timer_cursor);
    ...
    this.draw = function (gr, x, y) {
        ...
        if(this.bordercolor) gr.DrawRect(x-2, y+0, (this.w+4)-1, this.h-1, 1.0, this.bordercolor);
        gr.FillSolidRect(x-1,y+1,(this.w+2),this.h-2,this.backcolor & RGBA(255,255,255,this.backcolor_alpha));
