...
oListBox = function(id, object_name, x, y, w, h, row_height, label, arr, selectedId, func, parentObject, parentPageId, offset) {
    ...
    this.draw = function(gr){
        ...
        for(var i = this.offset; i < fin; i++) {
            ...
            if(i==this.selectedId) gr.FillSolidRect(this.x + 1, this.ly + row*this.rowHeight + 1, this.w - this.scrollbarWidth - 2, this.rowHeight - 1, RGBA(150,150,150,200));
...
oSettings = function() {
	...
	this.setButtons = function() {
        ...
        var button_zoomSize = 0, button_zoomSizeW = 0, button_zoomSizeH = 0, rect_w = 0;
    ...
    this.draw = function(gr) {
        ...
        var tx=20, ty=cSettings.topBarHeight - zoom(1, g_dpi), tw=0, th=this.txtHeight+zoom(10,g_dpi)+cHeaderBar.borderWidth, tpad=10+cSettings.tabPaddingWidth, cx=0, cw=0;
    ...
    this.on_mouse = function(event, x, y, delta) {
        var state = null, found = false, fin = "";
